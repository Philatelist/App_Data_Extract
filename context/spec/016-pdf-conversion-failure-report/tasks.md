...
- [ ] **Slice 1: Consolidated PDF failure report with reasons**
  ...
  - [ ] Verify: `mvn test -Dtest=PdfConverterTest,AttachmentDownloaderTest -q` — all tests pass. **[Agent: java-backend]**

---

- [ ] **Slice 2: PACKAGING always runs + remove legacy Signed PDFs step**
